...
use crate::common::{
    CpuState, MpState, VcpuExit,
};

#[cfg(target_arch = "x86_64")]
use crate::x86_64::{CpuId, ExtendedControlRegisters, LapicState, MsrEntries,
    Xsave, FpuState, SpecialRegisters, StandardRegisters, VcpuEvents
};
use thiserror::Error;
