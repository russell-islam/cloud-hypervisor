...
impl Vcpu {
    ...
    pub fn configure(
        ...
        arch::x86_64::interrupts::set_lint(&self.fd)
            .map_err(|e| Error::LocalIntConfiguration(e.into()))?;
        Ok(())
    }
...
impl CpuManager {
    pub fn new(
        ...
        #[cfg(target_arch = "x86_64")]
        let cpuid = CpuManager::patch_cpuid(hypervisor)?;
    ...
    #[cfg(target_arch = "x86_64")]
    fn patch_cpuid(hypervisor: Arc<dyn hypervisor::Hypervisor>) -> Result<CpuId> {
