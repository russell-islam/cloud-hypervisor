...
pub enum VfioPciError {
    ...
    IrqFd(hypervisor::Error),
    NewVfioPciDevice,
    MapRegionGuest(hypervisor::Error),
    SetGsiRouting(hypervisor::Error),
    MsiNotConfigured,
    MsixNotConfigured,
...
impl VfioPciDevice {
    ...
    pub fn map_mmio_regions<F>(&mut self, vm: &Arc<dyn GenVmFd>, mem_slot: F) -> Result<()>
    where
        F: Fn() -> u32,
    {
